...
Also analyze any website for personality, voice, palette, and social trends — then open **Content studio** to pick a voice, add a mascot, pull Instagram posts as **IG-XX** references, generate engagement drafts, and export **platform-sized PNG post images**.
